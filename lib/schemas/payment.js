...
const currencyEnum = require('./currencies.json');
...
const all = [
  'id', 'amount', 'currency', 'creator', 'validated', 'paymentService',
  'paymentServiceId', 'status', 'error', 'orderId', 'orderService', 'created'
];
